...
//--------------------------Generate Table Data-----------------------------//
    ...
    m_rows_2.add(PlutoRow(cells: {
      'inspection_date': PlutoCell(value: '2023-2-2'),
      'inspection_status': PlutoCell(value: 'Active'),
      'inspection_by': PlutoCell(value: 'KJR'),
      'inspection_comment': PlutoCell(value: 'PPP'),
      'inspection_value': PlutoCell(value: '123'),
      'next_inspection'  : PlutoCell(value: '2023-2-2'),
    }));
    ...
    if(pageMode == 1) {
      return  Column(
        children: [
          ...
          SizedBox(height: screenHeight - 300, child: ContextMenuRegion(
            ...
            TitledContainer(
                ...
                Column(
                  children: [
                    ...
                    SizedBox(height: 10),
                    SizedBox(height: 320, child: PlutoGrid(
                      columns: columns_2,
                      rows: rows_2,
                      onLoaded: (PlutoGridOnLoadedEvent event) {
      ...
      return ListView(
          children: [
            ...
            TitledContainer(titleText: 'Inspection Images',
                child: Row(children: [
                  SizedBox(height: 200, child: Text('Drag and drop asset image here with a short description.'))
                ])
            ),
          ]);
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            m_treeview != null? SizedBox(width: 300,child: m_treeview!) : SizedBox(width: 300),
